...
export class KieAiNode {
    ...
    static async createTask(params: {
        ...
        const ENGINE_VERSION = '2026.04.28.1730';
        console.log(`[KieAiNode v${ENGINE_VERSION}] 🔥 [KIE-API-V1] Creating task with model: ${params.model}`);
        ...
        let payload: any = {
            model: modelName,
            input: input,
            callBackUrl: process.env.BACKEND_URL ? `${process.env.BACKEND_URL.replace(/[, ]/g, '')}/api/internal/generation-callback` : undefined
        };
