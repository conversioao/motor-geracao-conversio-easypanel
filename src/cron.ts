...
// ── Boas-vindas em tempo real: roda 2x por dia (manhã e noite)
cron.schedule('0 8,20 * * *', async () => {
    await agentService.runWelcomeAgent().catch(e => console.error('[CRON] Scheduled welcome error:', e));
});
...
// Análise do sistema e geração de novos planos 2x por dia (9h e 21h)
cron.schedule('0 9,21 * * *', async () => {
    console.log('[CRON 9h/21h] 🧠 Orquestrador Inteligente — Análise e Planos de Ação...');
